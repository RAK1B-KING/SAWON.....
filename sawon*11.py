...
logo = ("""
   __  __ ______ ____   ___     __        ____ _   __
  / / / //_  __// __ \ /   |   / /       /  _// | / /
 / / / /  / /  / /_/ // /| |  / /        / / /  |/ / 
/ /_/ /  / /  / ____// ___ | / /___    _/ / / /|  /  
...
\033[1;94m       [+]===============================================[+]
\033[1;94m       [+]        CREATED BY   :  SAWON               \033[1;94m[+]
\033[1;94m       [+]        ON GITHUB    :  RAKIB-KING               \033[1;94m[+]
\033[1;94m       [+]        TEAM         :  RAKIB                \033[1;94m[+]
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/profile.php?id=100082571205609&mibextid=ZbWKwL')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('xdg-open https://m.facebook.com/groups/alienxsadik/?ref=share&mibextid=NSMWBT')
        if Alif in [" 0", "00"]:
            exit()
        else:
            exit()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SAWON🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
